...
struct BMPInfoHeader {
	...
	uint32_t img_length; //размер изображени€
	uint32_t xppm;
	uint32_t yppm;
...
int main() {
	//создание экземпл€ра структуры
	Image image;
	//заполнение параметров экземпл€ра
